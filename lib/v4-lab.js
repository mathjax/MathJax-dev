...
const texPackages = Object.keys(source)
                          .filter((name) => name.substring(0,6) === '[tex]/' && name !== '[tex]/all-packages')
                          .sort();

Object.assign(source, {
  '[mathjax-bbm-extension]/chtml': `../../mathjax-bbm-font-extension/chtml.js`,
  '[mathjax-bbm-extension]/svg':   `../../mathjax-bbm-font-extension/svg.js`,
  '[mathjax-bboldx-extension]/chtml': `../../mathjax-bboldx-font-extension/chtml.js`,
  '[mathjax-bboldx-extension]/svg':   `../../mathjax-bboldx-font-extension/svg.js`,
  '[mathjax-dsfont-extension]/chtml': `../../mathjax-dsfont-font-extension/chtml.js`,
  '[mathjax-dsfont-extension]/svg':   `../../mathjax-dsfont-font-extension/svg.js`
});
...
const Lab = window.Lab = {
  ...
  /**
   * Make sure the given packages' component files are run
   */
  loadPackages(names) {
    const promises = [];
    ...
    for (const name of names) {
      ...
      pkg.isLoaded = false;
      pkg.promise = pkg.makePromise(pkg.makeDependencies());
      promises.push(MathJax.loader.load(file));
    }
    return promises;
  },
  ...
  async Startup() {
    ...
    //
    if (MathJax.config.output.font !== 'mathjax-modern') {
